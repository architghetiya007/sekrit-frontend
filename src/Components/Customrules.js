        ...
        <div className="banner">
          ...
          <div className="banner-mid-details">   
            ...
            <div className="button">
              <button type="button" className="btn-repo">Repo</button>
              <button type="text" className="btn-default">
                Default<span>81</span></button>
              <button type="text" className="btn-custom">Custom<span>21</span></button>
            </div> 
          </div>    
          <div className="banner-contain">
            <div className="table-head">
              <div className="table-open-details">
                <p><img src={Openicon}></img>21 Open</p>
              </div>
              <div className="table-close-details">
                <p><img src={Closeicon}></img>20 Closed</p>
              </div>
            ...
            <div className="table-body">
              <div className="table-body-left">
                ...
                <div className="table-bottom">
                  ...
                  <div className="repo-link">
                    <p>| Detected secret in reponame/path/to/file/views.py:23</p>
                  </div>
